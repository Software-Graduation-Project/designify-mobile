...
/////////////This profile for store maneger ////////////////////
export default function ProfilePage() {
  ...
  const handleProfileDashboard = () => {
    Alert.alert("Profile Dashboard", "This feature is under development.");
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity
          ...
          onPress={handleProfileDashboard}
        >
          <Text style={styles.actionButtonText}>The Dashboard</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.actionButtonText}>The Orders</Text>
        </TouchableOpacity>
