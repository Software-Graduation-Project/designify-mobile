...
const ChatScreenStore = () => {
  const [messages, setMessages] = useState<IMessage[]>([]);
  const receiver = {
    name: "Sweet Touches",
    description:"Chat with Sweet Touches",
    photoUrl: require("../../assets/store/sweet.jpg"), //sweet.jpg Replace with the receiver's image URL
  };
...
export default ChatScreenStore;
